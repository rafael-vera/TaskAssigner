...
if (isset($_POST['submit'])) {
    ...
    //$nombre_tarea, $desc_tarea, $fecha_lim_tarea, $correo_empleado, $id_proyecto
    if($val){
        header("Location: index.php?id=".$_GET['id']);
    } else{
                    ...
                    <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                        <div class="card shadow-lg bg-light">
                            <form action="" method="POST" class="card-body p-5 text-center">
                                <h3 class="mb-5">Agregar tarea al Empleado</h3>

                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floating-email" name="nom_tarea" required>
                                    <label for="floating-text">Nombre de la Tarea</label>
                                </div>
                                ...
                                <select class="form-select my-auto" aria-label="Default select example" name="puesto" disabled>
